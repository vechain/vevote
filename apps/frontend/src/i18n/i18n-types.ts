...
JPG, PNG or SVG of maximum of {size}MB.
  ...
  proposal: {
     ...
     * The voting participation didn't reached the minimum required of {quorum}% to get approval.
     */
    the_voting_participation_didnt_reached_the_minimum_required_of_30_to_get_approval: (arg: {
      quorum: number;
    }) => LocalizedString;
    /**
     * A minimum of {quorum}% participation must be reached to validate the voting of the proposal and get approval.
     */
    a_minimum_of_30_participation_must_be_reached_to_validate_the_voting_of_the_proposal_and_get_approval: (arg: {
      quorum: number;
    }) => LocalizedString;
    /**
