...
export const SubmitVoteModal = ({ submitVoteModal }: { submitVoteModal: UseDisclosureReturn }) => {
  ...
  if (isSuccess) {
    ...
    return (
      <Modal isOpen={submitVoteModal.isOpen} onClose={submitVoteModal.onClose} trapFocus={false} size="md">
        ...
        <ModalBody pb={6}>
          <VStack spacing={6} align="stretch">
            ...
            <Button
              ...
              fontWeight={600}
              leftIcon={
                isTransactionPending ? <Spinner size="sm" /> : <Icon as={CheckIcon} boxSize={4} color="white" />
              }
              w="full">
              Confirm vote
            </Button>
