...
import { CreateProposalStep, SingleChoiceEnum, VotingEnum } from "@/types/proposal";
...
const SingleChoiceFields = () => {
  ...
  const defaultSingleChoice = [SingleChoiceEnum.AGAINST, SingleChoiceEnum.FOR, SingleChoiceEnum.ABSTAIN];
  return (
    <>
