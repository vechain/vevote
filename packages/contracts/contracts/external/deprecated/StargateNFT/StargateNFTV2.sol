...
import { DataTypesV2 as DataTypes } from "./libraries/DataTypesV2.sol";
import { MintingLogicV2 as MintingLogic } from "./libraries/MintingLogicV2.sol";
import { TokenV2 as Token } from "./libraries/TokenV2.sol";
import { ClockV2 as Clock } from "./libraries/ClockV2.sol";
import { SettingsV2 as Settings } from "./libraries/SettingsV2.sol";
import { ErrorsV2 as Errors } from "./libraries/ErrorsV2.sol";
import { VetGeneratedVthoV2 as VetGeneratedVtho } from "./libraries/VetGeneratedVthoV2.sol";
import { LevelsV2 as Levels } from "./libraries/LevelsV2.sol";
  ...
  IStargateNFTV2
{
  ...
  function setStargateDelegation(address _stargateDelegation) public onlyRole(DEFAULT_ADMIN_ROLE) {
    DataTypes.StargateNFTStorage storage $ = _getStargateNFTStorage();
  ...
  function getLastVetGeneratedVthoClaimTimestamp(uint256 _tokenId) external view returns (uint48) {
    DataTypes.StargateNFTStorage storage $ = _getStargateNFTStorage();
  ...
  function calculateVTHO(uint48 _t1, uint48 _t2, uint256 _vetAmount) external pure returns (uint256) {
