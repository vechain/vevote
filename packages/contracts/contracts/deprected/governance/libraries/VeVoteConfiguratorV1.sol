...
library VeVoteConfiguratorV1 {
  ...
  function setStargateNFTContract(VeVoteStorageTypes.VeVoteStorage storage self, address newContractAddress) external {
    ...
    self.stargateNFT = IStargateNFTV2(newContractAddress);
   ...
   */
  function getStargateNFTContract(VeVoteStorageTypes.VeVoteStorage storage self) internal view returns (IStargateNFTV2) {
