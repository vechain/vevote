...
import {INodeManagement} from "../../interfaces/INodeManagement/INodeManagement.sol";
 ...
 */
contract NodeManagement is INodeManagementV3, AccessControlUpgradeable, UUPSUpgradeable {
    ...
    function setStargateNft(address stargateNft) external onlyRole(DEFAULT_ADMIN_ROLE) {
        require(
            stargateNft != address(0),
            "NodeManagement: stargateNft cannot be the zero address"
        );
